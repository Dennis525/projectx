...
export default function App({ Component, pageProps }) {
    return (
        <>
            <Head>
                <title>Online Electronic Shop | JS Dennis</title>
                <meta
                    name="NetShop Ecommerce"
                    content="We are trusted online shop for wide range of computer accessories and networking services"
                />
                <meta
                    name="viewport"
